...
setup(
    name="django-stagesetting-curtaincall",
    version="0.1.0",
    author="Keryn Knight",
    author_email="django-stagesetting-curtaincall@kerynknight.com",
    maintainer="Keryn Knight",
    maintainer_email="django-stagesetting-curtaincall@kerynknight.com",
    description=SHORT_DESCRIPTION[0:200],
    long_description=LONG_DESCRIPTION,
    packages=[
        "stagesetting_curtaincall",
    ],
